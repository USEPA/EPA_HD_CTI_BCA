...
if __name__ == '__main__':
    ...
    per_veh_tc_by_year_dict = calc_per_veh_tech_costs(settings, vehicles_rc, per_veh_dc_by_year_dict, per_veh_ic_by_year_dict)
    ...
    fleet_dict = calc_tech_costs(settings, vehicles_st, per_veh_tc_by_year_dict, fleet_dict)
