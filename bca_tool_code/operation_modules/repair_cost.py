...
class EmissionRepairCost:
    ...
    def calc_using_cost_per_year(self, settings, vehicle, pkg_cost, reference_pkg_cost):
        ...
        if vehicle.age_id <= warranty_age_ap:
            ...
            repair_cost = 0
        # if vehicle.age_id == 0:
        #     in_warranty_cost_per_veh = no_action_warranty_cost_per_year * share_with_extended * (1 + new_tech_adj_factor)
        #     in_warranty_cost_per_veh += action_warranty_cost_per_year * (1 - share_with_extended) * (1 + new_tech_adj_factor)
        #     in_warranty_cost = in_warranty_cost_per_veh * vehicle.vpop
        #     repair_cost_per_veh = 0
        #     repair_cost = 0
        # elif 0 < vehicle.age_id + 1 <= warranty_age_ap:
