...
class Vehicle:
    ...
    def set_vehicle_id(self):
        # return (self.sourcetype_id, self.engine_id)
    ...
    def init_from_file(self, filepath, options, adjustments=None): #, techpens=None):
        """
        ...
        Vehicle.year_min = year_min

        year_max = df['year_id'].max()
        Vehicle.year_max = year_max
        ...
        # if techpens:
        #     self.define_attributes_for_techpens()
    ...
    #
    # def define_attributes_for_techpens(self):
    #     """
    #
    #     Parameters:
    #         program: str; represents the program for the given instance (i.e., 'CAP' or 'GHG').\n
    ...
    #
    #     """
    #     self.attributes_for_techpens = ['vpop']

    def create_vehicle_df(self, df, year_min, options, adjustments=None): #, techpens=None):
        """
        ...
        #     for (vehicle, alt) in vehicles:
        #         for modelyear_id in Vehicle.years:
        #             st, rc, ft = vehicle
