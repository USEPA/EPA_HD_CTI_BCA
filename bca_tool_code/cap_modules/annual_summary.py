...
class AnnualSummaryCAP:
    ...
    def create_annual_summary_dict():
        ...
        AnnualSummaryCAP._dict.clear()

        return AnnualSummaryCAP._dict
    ...
    def get_attribute_value(key, attribute_name):
        ...
        return AnnualSummaryCAP._dict[key][attribute_name]
    ...
    def update_dict(key, input_dict):
        ...
        for attribute_name, attribute_value in input_dict.items():
            AnnualSummaryCAP._dict[key][attribute_name] = attribute_value
