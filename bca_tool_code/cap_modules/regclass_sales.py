...
class RegClassSales:
    ...
    def create_regclass_sales_dict(self, data_object, cost_steps):
        """
        ...
        Returns:
            ...
            tuple (regclass_id, fueltype_id), and values representing sales (sales=VPOP at ageID=0) for each key by
            model year; creates other attributes specified in the class __init__.
    ...
    def get_attribute_value(self, key, attribute_name):
        ...
        Parameters:
            key: tuple; ((regclass_id, fueltype_id), option_id, model year). \n
    ...
    def update_dict(self, key, input_dict):
        ...
        Parameters:
            key: ((regclass_id, fueltype_id), option_id, model year). \n
