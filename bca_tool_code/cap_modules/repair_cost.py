...
def calc_typical_vmt_per_year(settings, vehicle):
    ...
    cumulative_vmt = vehicle.vmt_per_veh_cumulative
    # cumulative_vmt = [v for v in settings.fleet_cap.vehicles
...
def calc_emission_repair_cost(settings, vehicle, pkg_cost, reference_pkg_cost):
    """
    ...
    typical_vmt = calc_typical_vmt_per_year(settings, vehicle)

    # calculate estimated ages at which warranty and useful life will occur
    calc_estimated_age(settings, vehicle, typical_vmt)
    ...
    settings.repair_cpm_dict[veh_id, option, my, age] = {
