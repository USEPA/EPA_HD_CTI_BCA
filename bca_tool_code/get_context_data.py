...
class FuelPrices:
    ...
    def get_prices(self):
        ...
        fuel_prices_df = Deflators.convert_dollars_to_analysis_basis(fuel_prices_df, 'retail_fuel_price', 'pretax_fuel_price')
...
if __name__ == '__main__':
    ...
    fuel_prices_obj = FuelPrices(fuel_prices_file, aeo_case_1, 'full name', 'Motor Gasoline', 'Diesel')
    ...
    fuel_prices_obj = FuelPrices(fuel_prices_file, aeo_case_2, 'full name', 'Motor Gasoline', 'Diesel')
    fuel_prices = fuel_prices_obj.get_prices()
    fuel_prices.to_csv(path_dev / f'fuel_prices_{aeo_case_2}.csv', index=False)

    aeo_case_3 = 'Low oil price'
    fuel_prices_obj = FuelPrices(fuel_prices_file, aeo_case_3, 'full name', 'Motor Gasoline', 'Diesel')
    fuel_prices = fuel_prices_obj.get_prices()
