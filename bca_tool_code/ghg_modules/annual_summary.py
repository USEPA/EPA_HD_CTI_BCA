...
class AnnualSummaryGHG:
    ...
    @staticmethod
    def annual_summary(settings, source, destination, options):
        """
            ...
            for social_discount_rate in rates:
                ...
                for arg in non_emission_cost_args:
                    for calendar_year in years:
                        ...
                        arg_annualized = AnnualSummaryGHG.calc_annualized_value(present_value, rate, periods,
                                                                                annualized_offset)
    ...
    def get_attribute_value(key, attribute_name):
        ...
        return AnnualSummaryGHG._dict[key][attribute_name]
    ...
    def update_dict(key, input_dict):
        ...
        for attribute_name, attribute_value in input_dict.items():
            AnnualSummaryGHG._dict[key][attribute_name] = attribute_value

    @staticmethod
    def add_key_value_pairs(key, input_dict):

        AnnualSummaryGHG._dict[key] = input_dict
