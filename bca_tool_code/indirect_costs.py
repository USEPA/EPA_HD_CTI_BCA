...
# def calc_project_markup_value(settings, engine, alt, markup_factor, model_year):
#     """
#
...
#     """
#     rc, ft = engine
#     scaled_markups_dict_id = (engine, alt, markup_factor, model_year)
...
#     else:
#         # input_markup_value, scaler, scaled_by, num_years = settings.markup_inputs_regclass_dict[(ft, markup_factor)]['Value'], \
#         #                                                    settings.markup_inputs_regclass_dict[(ft, markup_factor)]['Scaler'], \
#         #                                                    settings.markup_inputs_regclass_dict[(ft, markup_factor)]['Scaled_by'], \
#         #                                                    settings.markup_inputs_regclass_dict[(ft, markup_factor)]['NumberOfYears']
#         input_markup_value, scaler, scaled_by, num_years = settings.markup_inputs_regclass_dict[((ft, markup_factor), alt)]['Value'], \
#                                                            settings.markup_inputs_regclass_dict[((ft, markup_factor), alt)]['Scaler'], \
#                                                            settings.markup_inputs_regclass_dict[((ft, markup_factor), alt)]['Scaled_by'], \
#                                                            settings.markup_inputs_regclass_dict[((ft, markup_factor), alt)]['NumberOfYears']
#         if scaler == 'Absolute':
#             project_markup_value = \
#                 (settings.required_miles_and_ages_dict[(engine, alt, scaled_by, scaling_metric)][f'{model_year}']
#                  / settings.required_miles_and_ages_dict[(engine, alt, scaled_by, scaling_metric)]['2024']) \
#                 * input_markup_value
#         if scaler == 'Relative':
#             project_markup_value = \
#                 (settings.required_miles_and_ages_dict[(engine, alt, scaled_by, scaling_metric)][f'{model_year}']
#                  / settings.required_miles_and_ages_dict[(engine, alt, scaled_by, scaling_metric)][str(int(model_year) - int(num_years))]) \
#                 * input_markup_value
#         if scaler == 'None':
...
#         for markup_factor in settings.markup_factors_unique_names:
#             markup_value = calc_project_markup_value(settings, vehicle, markup_factor, model_year)
#             if markup_factor == settings.markup_factors_unique_names[0]:
...
def calc_indirect_costs(settings, totals_dict, averages_dict):
    ...
    # markup_factors = [arg for arg in settings.markups_regclass['Markup_Factor'].unique()]
