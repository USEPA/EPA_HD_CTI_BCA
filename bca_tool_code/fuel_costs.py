...
def calc_thc_reduction(settings, key):
    """
    ...
    thc_no_action = settings.fleet_cap.get_attribute_value(no_action_key, 'THC_UStons')
    thc_action = settings.fleet_cap.get_attribute_value(key, 'THC_UStons')
