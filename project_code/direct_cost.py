...
class DirectCost:
    ...
    def __init__(self, _veh, step, costs_df, seedvol_df, sales_df):
        ...
        :param step: The given implementation step (e.g., the CTI proposal called for new standards in 2027 and then a second set of new standards
        in 2030; these would be two separate implementation steps.
